...
export class ProductService {
  private baseUrl = 'https://clothing-store-api-26.onrender.com/api/product';
  private searchUrl = 'https://clothing-store-api-26.onrender.com/api/product/search';
  private detailUrl = 'https://clothing-store-api-26.onrender.com/api/product/detail';
  private adminUrl ="https://clothing-store-api-26.onrender.com/api/admin/upload"
